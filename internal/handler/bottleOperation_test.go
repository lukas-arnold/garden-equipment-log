...
func TestHandleEditBottleOperation(t *testing.T) {
	...
	bottle, _ := h.storage.GetBottle(
		bottles[0].Id,
	)

	id := bottle.OperationHistory[0].Id

	req := httptest.NewRequest(
		"GET",
		"/bottle/operation/edit",
		nil,
	)
