...
func (h *Handler) HandleDevicesView(
...
func (h *Handler) HandleAddDeviceGet(
	w http.ResponseWriter,
	r *http.Request,
) {
	h.renderTemplate(
...
func (h *Handler) HandleAddDevicePost(
	w http.ResponseWriter,
	r *http.Request,
) {
...
func (h *Handler) HandleEditDevice(
	w http.ResponseWriter,
	r *http.Request,
) {
...
func (h *Handler) HandleSaveDevice(
	w http.ResponseWriter,
	r *http.Request,
) {
	id, err := utils.ConvertId(
	...
	err = h.storage.UpdateDevice(device)
...
func (h *Handler) HandleDeleteDevice(
	w http.ResponseWriter,
	r *http.Request,
) {
	id, err := utils.ConvertId(
...
func (h *Handler) HandleDeviceHistory(
	w http.ResponseWriter,
	r *http.Request,
) {
	id, err := utils.ConvertId(
	...
	h.renderHistoryTemplate(
		...
		deviceHistoryPageData{
			Device: device,
			Chart:  chart,

			OperationRows: buildDeviceHistoryRows(
				device,
			),
		},
	)
